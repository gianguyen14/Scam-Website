...
class AdvancedVisionAI:
    def __init__(self, registry_path="data/brand_registry"):
        ...
        if not TORCH_AVAILABLE:
            print("PyTorch missing (Serverless mode). Fallbacking Vision to structurally mock rules.")
            return
    ...
    def decode_image(self, b64_str: str):
    ...
    def analyze(self, screenshot_b64: str, current_domain: str) -> Dict[str, Any]:
        ...
        if not TORCH_AVAILABLE:
            # Fallback Serverless behavior: if there's a huge b64 payload but no CNN, skip deep process.
            return {"score": 0.0, "reason": "Deep Vision skipped in Serverless Mode."}
